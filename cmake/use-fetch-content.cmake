...
if(NOT BEMAN_EXPECTED_LOCKFILE)
    set(BEMAN_EXPECTED_LOCKFILE
        "lockfile.json"
        CACHE FILEPATH
...
message(TRACE "BEMAN_EXPECTED_LOCKFILE=\"${BEMAN_EXPECTED_LOCKFILE}\"")
file(
    REAL_PATH "${BEMAN_EXPECTED_LOCKFILE}"
